...
export const Players: Player[] = [
  ...
  { id: 20, nick: "player20", mmr: 4500, roles: [Rol.SoftSupport] },
  // { id: 21, nick: "Axalon", mmr: 1744, roles: [Rol.SoftSupport] },
  // { id: 22, nick: "Sebas", mmr: 7425, roles: [Rol.MidLane, Rol.SoftSupport] },
  // { id: 23, nick: "Lion", mmr: 8011, roles: [Rol.MidLane, Rol.SafeLane] },
  // { id: 24, nick: "BOZS", mmr: 5006, roles: [Rol.MidLane] },
  // { id: 25, nick: "ΛLΞX", mmr: 7955, roles: [Rol.OffLane] },
  // {
  //   id: 26,
  //   nick: "nabissor",
  //   mmr: 3347,
